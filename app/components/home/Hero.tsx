...
export default function Hero() {
  return (
    <section
      className="pt-[35px] pb-[70px] 2xl:pt-[70px] 2xl:pb-[140px]"
      id="hero">
      <div className="wrapper">
        <section className="mx-auto flex flex-col items-center gap-y-[35px] lg:flex-row lg:items-start lg:justify-between lg:gap-y-0 2xl:justify-evenly">
